...
public class PreAuthCompTransaction extends BaseOnlineTransaction {
    private final IRepository iRepository;

    @Inject
    public PreAuthCompTransaction(IRepository iRepository, IPosService posService) {
        super(iRepository, posService, TransType.PREAUTH_COMP);
