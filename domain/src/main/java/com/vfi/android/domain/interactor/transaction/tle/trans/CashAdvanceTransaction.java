...
public class CashAdvanceTransaction extends BaseOnlineTransaction {

    @Inject
    public CashAdvanceTransaction(IRepository iRepository, IPosService posService) {
        super(iRepository, posService, TransType.CASH_ADV);
    }
