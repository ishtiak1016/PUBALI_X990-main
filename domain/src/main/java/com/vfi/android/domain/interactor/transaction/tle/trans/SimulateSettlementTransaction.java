...
public class SimulateSettlementTransaction extends BaseTransaction implements ITransaction {
    private final String TAG = TAGS.Settlement;
    private final SettlementRecordItem settlementRecordItem;

    @Inject
    public SimulateSettlementTransaction(IRepository iRepository, IPosService posService, SettlementRecordItem settlementRecordItem) {
