...
public class EmvCTLSApplicationsConfigParser implements ConfigParser<EmvApplication>{
    private final String fileName = "/demo_xml/EMV_CTLS_Applications.xml";
    private final String beanTAG = "Application";
    private final UseCaseConfigAIDs useCaseConfigAIDs;

    @Inject
    public EmvCTLSApplicationsConfigParser(UseCaseConfigAIDs useCaseConfigAIDs) {
    ...
    public EmvApplication createBean() {
        return new EmvApplication(true);
    }
    ...
    public void doFinishProcess(List<EmvApplication> beanList) {
        ...
        while (iterator.hasNext()) {
            ...
            aidParams.setAIDPrmType(2);
            aidParams.setAIDStr(emvApplication.toEmvAppString(true));
            useCaseConfigAIDs.execute(aidParams);
