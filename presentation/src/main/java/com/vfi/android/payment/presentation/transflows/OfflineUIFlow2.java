...
import static com.vfi.android.payment.presentation.navigation.UIState.UI_STATE_INPUT_APPROVAL_CODE;
...
public class OfflineUIFlow2 extends BaseTransFlow implements TransUiFlow {
    ...
    public void navigatorToNext(Context context, UINavigator uiNavigator) {
        ...
        int[] supportUiBackStateList = {UI_STATE_TRANS_ENTRY, UI_STATE_CHECK_PASSWD,
                UI_STATE_INPUT_TIP_AMOUNT, UI_STATE_SCAN};
        ...
        switch (controlData.getStackTopUIState()) {
            ...
            case UI_STATE_INPUT_APPROVAL_CODE:
                ui_state_input_approval_code(context, controlData);
                break;
    ...
    private void ui_state_input_card_num(Context context, UIFlowControlData controlData) {
        jumpToState(context,UI_STATE_SELECT_HOST_MERCHANT,  SelectHostMerchantActivity.class);
    }
    ...
    private void ui_state_input_card_expiry_date(Context context, UIFlowControlData controlData) {
        if (controlData.isNeedInputCVV2()) {
            ...
            jumpToState(context, UI_STATE_INPUT_APPROVAL_CODE, InputApprovalCodeActivity.class);
        }
    }
    ...
    private void ui_state_input_approval_code(Context context, UIFlowControlData controlData) {
